    ...
    return (
        <div className="showcase">
            <div className="showcase__left">
                ...
                <img className="showcase__left__sticker" src={sticker} alt="" />
            ...
            <div className="showcase__right">
                <div className="showcase__right__item">
                    <img src={beddingSet} alt="" height="290px" width="290px" />
                ...
                <div className="showcase__right__item">
                    <img src={livingSet} alt="" height="290px" width="290px" />
                    <span className="showcase__right__item-title">
                        Living Sets
                    </span>
                    <span className="showcase__right__item-description">
                ...
                <div className="showcase__right__item">
                    <img src={outdoorSet} alt="" height="290px" width="290px" />
                    <span className="showcase__right__item-title">
                        Outdoor Sets
                    </span>
                    <span className="showcase__right__item-description">
