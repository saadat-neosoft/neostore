...
const ProductDetailRight = () => {
    return (
        <div>
            ...
            <div className="product-detail__in-stock">Brand: Studio Design</div>
            <div className="product-detail__in-stock">Reference: demo_3</div>
            <div className="product-detail__in-stock">In stock 191 Items</div>
            ...
            <div className="product-detail__cart">
                ...
                <span className="product-detail__qty">1</span>
                <span className="product-detail__qty-update-container">
                    <button className="product-detail__qty-update-up">
                        <img src={upArrow} alt="" />
                    </button>
                    <button className="product-detail__qty-update-down">
