        ...
        <>
            <div>
                ...
                <div className="product-detail__info">
                    ...
                    aliqua. Turpis egestas sed tempus urna et pharetra pharetra
                    massa. Tincidunt augue interdum velit euismod in
                    pellentesque massa placerat. Pharetra diam sit amet nisl
                    suscipit adipiscing Ut sem viverra aliquet eget sit amet
                    tellus cras adipiscing. Nullam eget felis eget nunc lobortis
                    mattis.Nisi vitae suscipit tellus mauris. Facilisi nullam
                    vehicula ipsum.
                </div>
                        ...
                        <div className="product-detail__cart-notification__card__body">
                            ...
                            <div className="product-detail__cart-notification__card__body__details">
                                ...
                                <p className="product-detail__cart-notification__card__body__shipping">
                                    Threshold Delivery - additional cost per
                                    unit: ₹400.00 In-stock Usually ships in 1-7
                                    business days.
                                </p>
                                <p className="product-detail__cart-notification__card__body__shipping">
                                    *Price does not include shipping and
                                    processing, gift wrap, discounts or taxes
                                </p>
